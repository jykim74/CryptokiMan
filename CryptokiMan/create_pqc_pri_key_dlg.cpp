...
void CreatePQCPriKeyDlg::setSlotIndex(int index)
{
    slot_index_ = index;
...
void CreatePQCPriKeyDlg::initUI()
{
    mAlgCombo->addItems( kPQCTypeList );
    changeAlg();
}

void CreatePQCPriKeyDlg::changeAlg()
{
    mParamCombo->clear();
...
void CreatePQCPriKeyDlg::initialize()
{
    QString strTitle;

    strTitle = tr( "Create PQC private key" );
...
void CreatePQCPriKeyDlg::initAttributes()
{
...
void CreatePQCPriKeyDlg::setAttributes()
{
...
void CreatePQCPriKeyDlg::connectAttributes()
{
...
void CreatePQCPriKeyDlg::accept()
{
    int rv = -1;
...
void CreatePQCPriKeyDlg::clickGenKey()
{
    int ret = 0;
    BIN binPub = {0,0};
    BIN binPri = {0,0};
...
void CreatePQCPriKeyDlg::clickFindKey()
{
    int ret = 0;
    int nKeyType = -1;
    int nParam = -1;
...
void CreatePQCPriKeyDlg::clickUseSKI()
{
    bool bVal = mUseSKICheck->isChecked();
    mIDText->setEnabled( !bVal );
}

void CreatePQCPriKeyDlg::clickUseSPKI()
{
    bool bVal = mUseSPKICheck->isChecked();
    mPubKeyInfoText->setEnabled( !bVal );
}

void CreatePQCPriKeyDlg::clickPrivate()
{
    mPrivateCombo->setEnabled(mPrivateCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickDecrypt()
{
    mDecryptCombo->setEnabled(mDecryptCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickSign()
{
    mSignCombo->setEnabled(mSignCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickSignRecover()
{
    mSignRecoverCombo->setEnabled(mSignRecoverCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickUnwrap()
{
    mUnwrapCombo->setEnabled(mUnwrapCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickModifiable()
{
    mModifiableCombo->setEnabled(mModifiableCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickCopyable()
{
    mCopyableCombo->setEnabled(mCopyableCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickDestroyable()
{
    mDestroyableCombo->setEnabled(mDestroyableCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickSensitive()
{
    mSensitiveCombo->setEnabled(mSensitiveCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickDerive()
{
    mDeriveCombo->setEnabled(mDeriveCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickExtractable()
{
    mExtractableCombo->setEnabled(mExtractableCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickToken()
{
    mTokenCombo->setEnabled(mTokenCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickStartDate()
{
    mStartDateEdit->setEnabled(mStartDateCheck->isChecked());
}

void CreatePQCPriKeyDlg::clickEndDate()
{
    mEndDateEdit->setEnabled(mEndDateCheck->isChecked());
}
...
void CreatePQCPriKeyDlg::setDefaults()
{
