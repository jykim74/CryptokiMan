...
#define ACT_OBJECT_CREATE_PQC_PUB_KEY   VIEW_OBJECT | 0x00000800
#define ACT_OBJECT_CREATE_PQC_PRI_KEY   VIEW_OBJECT | 0x00001000
#define ACT_OBJECT_CREATE_KEY           VIEW_OBJECT | 0x00002000
#define ACT_OBJECT_DEL_OBJECT           VIEW_OBJECT | 0x00004000
#define ACT_OBJECT_EDIT_ATT             VIEW_OBJECT | 0x00008000
#define ACT_OBJECT_EDIT_ATT_LIST        VIEW_OBJECT | 0x00010000
#define ACT_OBJECT_COPY_OBJECT          VIEW_OBJECT | 0x00020000
#define ACT_OBJECT_FIND_OBJECT          VIEW_OBJECT | 0x00040000
