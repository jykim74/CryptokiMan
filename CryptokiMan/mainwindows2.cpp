...
void MainWindow::viewFileOpen( bool bChecked )
{
    if( bChecked == true )
    {
        file_tool_->insertAction( unload_act_, open_act_ );
...
void MainWindow::viewFileUnload( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        file_tool_->insertAction( show_dock_act_, unload_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewModuleInit( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        module_tool_->insertAction( final_act_, init_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewModuleFinal( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        module_tool_->insertAction( open_sess_act_, final_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewModuleOpenSess( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        module_tool_->insertAction( close_sess_act_, open_sess_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewModuleCloseSess( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        module_tool_->insertAction( close_all_act_, close_sess_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewModuleCloseAll( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        module_tool_->insertAction( login_act_, close_all_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewModuleLogin( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        module_tool_->insertAction( logout_act_, login_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectGenKeyPair( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( gen_key_act_, gen_keypair_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectGenKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( create_data_act_, gen_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectCreateData( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( create_rsa_pub_key_act_, create_data_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectCreateRSAPubKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( create_rsa_pri_key_act_, create_rsa_pub_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectCreateRSAPriKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( create_ec_pub_key_act_, create_rsa_pri_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectCreateECPubKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( create_ec_pri_key_act_, create_ec_pub_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectCreateECPriKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( create_ed_pub_key_act_, create_ec_pri_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectCreateEDPubKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( create_ed_pri_key_act_, create_ed_pub_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectCreateEDPriKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( create_dsa_pub_key_act_, create_ed_pri_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectCreateDSAPubKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( create_dsa_pri_key_act_, create_dsa_pub_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectCreateDSAPriKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( create_key_act_, create_dsa_pri_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectCreateKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( del_object_act_, create_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectDelObject( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( edit_att_act_, del_object_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectEditAtt( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( edit_att_list_act_, edit_att_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectEditAttList( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( copy_object_act_, edit_att_list_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewObjectCopyObject( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        object_tool_->insertAction( find_object_act_, copy_object_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewCryptRand( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        crypt_tool_->insertAction( digest_act_, rand_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewCryptDigest( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        crypt_tool_->insertAction( sign_act_, digest_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewCryptSign( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        crypt_tool_->insertAction( verify_act_, sign_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewCryptVerify( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        crypt_tool_->insertAction( enc_act_, verify_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewCryptEnc( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        crypt_tool_->insertAction( dec_act_, enc_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewCryptDec( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        crypt_tool_->insertAction( hsm_man_act_, dec_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewImportCert( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        import_tool_->insertAction( import_pfx_act_, import_cert_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewImportPFX( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        import_tool_->insertAction( import_pri_key_act_, import_pfx_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewToolInitToken( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        tool_tool_->insertAction( oper_state_act_, init_token_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewToolOperState( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        tool_tool_->insertAction( set_pin_act_, oper_state_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewToolSetPIN( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        tool_tool_->insertAction( init_pin_act_, set_pin_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewToolInitPIN( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        tool_tool_->insertAction( wrap_key_act_, init_pin_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewToolWrapKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        tool_tool_->insertAction( unwrap_key_act_, wrap_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewToolUnwrapKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        tool_tool_->insertAction( derive_key_act_, unwrap_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewToolDeriveKey( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        tool_tool_->insertAction( type_name_act_, derive_key_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewToolTypeName( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        tool_tool_->insertAction( make_csr_act_, type_name_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewToolMakeCSR( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        tool_tool_->insertAction( cavp_act_, make_csr_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewHelpHaltLog( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        help_tool_->insertAction( setting_act_, halt_log_act_ );
        setView( nAct );
    }
    else
    {
...
void MainWindow::viewHelpSetting( bool bChecked )
{
    ...
    if( bChecked == true )
    {
        help_tool_->insertAction( about_act_, setting_act_ );
        setView( nAct );
    }
    else
    {
